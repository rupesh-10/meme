							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="new-postbox">
										<figure>
											<img src="{{ asset('images/frontend/resources/admin2.jpg') }}" alt="">
										</figure>
								...
								<div class="central-meta item">
									<div class="user-post">
										<div class="friend-info">
											<figure>
												<img src="{{ asset('images/frontend/resources/friend-avatar10.jpg') }}" alt="">
											</figure>
											...
											<div class="post-meta">
												<img src="{{ asset('images/frontend/resources/user-post.jpg') }}" alt="">
											...
											<ul class="we-comet">
												<li>
													<div class="comet-avatar">
														<img src="{{ asset('images/frontend/resources/comet-1.jpg') }}" alt="">
													</div>
													...
													<ul>
														<li>
															<div class="comet-avatar">
																<img src="{{ asset('images/frontend/resources/comet-2.jpg') }}" alt="">
															</div>
															<div class="we-comment">
																<div class="coment-head">
														...
														<li>
															<div class="comet-avatar">
																<img src="{{ asset('images/fronend/resources/comet-3.jpg') }}" alt="">
															</div>
															<div class="we-comment">
																<div class="coment-head">
												...
												<li class="post-comment">
													<div class="comet-avatar">
														<img src="{{ asset('images/fronend/resources/comet-1.jpg') }}" alt="">
													</div>
								...
								<div class="central-meta item">
									<div class="user-post">
										<div class="friend-info">
											<figure>
												<img src="{{ asset('images/frontend/resources/nearly1.jpg') }}" alt="">
											</figure>
											<div class="friend-name">
